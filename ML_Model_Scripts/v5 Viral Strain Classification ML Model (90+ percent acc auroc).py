...
print("Concrete-ML AUROC (One vs Rest): ", roc_auc_score(y_test, model.predict_proba(X_test), multi_class='ovr'))
print("Concrete-ML AUROC (One vs One): ", roc_auc_score(y_test, model.predict_proba(X_test), multi_class='ovo'))
